resource "kubectl_manifest" "kubeflow-cert-manager-namespace" {
  yaml_body = <<YAML
apiVersion: v1
kind: Namespace
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-crd-certificaterequests" {
  yaml_body = <<YAML
...
resource "kubectl_manifest" "kubeflow-cert-manager-crd-certificates" {
  yaml_body = <<YAML
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-crd-challenges" {
  yaml_body = <<YAML
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-crd-clusterissuers" {
  yaml_body = <<YAML
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-crd-issuers" {
  yaml_body = <<YAML
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-crd-orders" {
  yaml_body = <<YAML
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-serviceaccount-cert-manager" {
  yaml_body = <<YAML
apiVersion: v1
...
depends_on = [ovh_cloud_project_kube.ovh_kube_cluster, ovh_cloud_project_kube_nodepool.control_plane_pool, kubectl_manifest.kubeflow-cert-manager-namespace]
}

resource "kubectl_manifest" "kubeflow-cert-manager-crd-serviceaccount-cainjector" {
  yaml_body = <<YAML
apiVersion: v1
automountServiceAccountToken: true
kind: ServiceAccount
...
resource "kubectl_manifest" "kubeflow-cert-manager-serviceaccount-webhook" {
  yaml_body = <<YAML
apiVersion: v1
automountServiceAccountToken: true
kind: ServiceAccount
...
resource "kubectl_manifest" "kubeflow-cert-manager-role-webhook" {
  yaml_body = <<YAML
...
resource "kubectl_manifest" "kubeflow-cert-manager-role-cainjector" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: Role
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-role-cert-manager" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: Role
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-cainjector" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-controller-approve" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-controller-certificates" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-controller-certificatesigningrequests" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-controller-challenges" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-controller-clusterissuers" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-controller-ingress-shim" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-controller-issuers" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-controller-orders" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-edit" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-view" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrole-webhook" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-rolebinding-webhook" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: RoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-rolebinding-cainjector" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: RoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-rolebinding-cert-manager" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: RoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrolebinding-cainjector" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrolebinding-controller-approve" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrolebinding-controller-certificates" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrolebinding-certificatesigningrequests" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrolebinding-controller-challenges" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrolebinding-controller-clusterissuers" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrolebinding-controller-ingress-shim" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrolebinding-controller-issuers" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrolebinding-controller-orders" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-clusterrolebinding-webhook" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-configmap-webhook" {
  yaml_body = <<YAML
apiVersion: v1
data: null
kind: ConfigMap
...
resource "kubectl_manifest" "kubeflow-cert-manager-service-cert-manager" {
  yaml_body = <<YAML
apiVersion: v1
kind: Service
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-service-webhook" {
  yaml_body = <<YAML
apiVersion: v1
kind: Service
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-deployment-cert-manager" {
  yaml_body = <<YAML
apiVersion: apps/v1
kind: Deployment
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-deployment-cainjector" {
  yaml_body = <<YAML
apiVersion: apps/v1
kind: Deployment
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-deployment-webhook" {
  yaml_body = <<YAML
apiVersion: apps/v1
kind: Deployment
metadata:
...
resource "kubectl_manifest" "kubeflow-cert-manager-mutatingwebhookconfiguration" {
  yaml_body = <<YAML
...
resource "kubectl_manifest" "kubeflow-cert-manager-validatingwebhookconfiguration" {
  yaml_body = <<YAML
apiVersion: admissionregistration.k8s.io/v1
...
depends_on = [ovh_cloud_project_kube.ovh_kube_cluster, ovh_cloud_project_kube_nodepool.control_plane_pool, kubectl_manifest.kubeflow-cert-manager-crd-clusterissuers, kubectl_manifest.kubeflow-cert-manager-deployment-webhook]
}

resource "kubectl_manifest" "cluster-issuer-production" {
  yaml_body = <<YAML
apiVersion: cert-manager.io/v1
kind: ClusterIssuer
metadata:
