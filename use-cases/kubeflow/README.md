...
Get your public cloud project ID from the OVH manager:

https://www.ovh.com/manager/#/public-cloud/pci/projects

Create an OpenStack user:

https://www.ovh.com/manager/#/public-cloud/pci/projects/<your_openstack_project_id>/users

Download the OpenStack RC file and save it as ovhrc.sh
