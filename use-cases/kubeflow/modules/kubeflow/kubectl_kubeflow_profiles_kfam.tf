resource "kubectl_manifest" "kubeflow-profiles-kfam-crd-profiles" {
  yaml_body = <<YAML
...
resource "kubectl_manifest" "kubeflow-profiles-kfam-serviceaccount-profiles-controller-service-account" {
  yaml_body = <<YAML
apiVersion: v1
kind: ServiceAccount
metadata:
...
resource "kubectl_manifest" "kubeflow-profiles-kfam-role-profiles-leader-election-role" {
  yaml_body = <<YAML
...
resource "kubectl_manifest" "kubeflow-profiles-kfam-rolebinding-profiles-leader-election-rolebinding" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: RoleBinding
metadata:
...
resource "kubectl_manifest" "kubeflow-profiles-kfam-clusterrolebinding-profiles-cluster-rolebinding" {
  yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
...
resource "kubectl_manifest" "kubeflow-profiles-kfam-configmap-namespace-labels-data" {
  yaml_body = <<YAML
apiVersion: v1
data:
...
resource "kubectl_manifest" "kubeflow-profiles-kfam-configmap-profiles-config" {
  yaml_body = <<YAML
apiVersion: v1
data:
  ADMIN: ""
...
resource "kubectl_manifest" "kubeflow-profiles-kfam-service-profiles-kfam" {
  yaml_body = <<YAML
apiVersion: v1
kind: Service
metadata:
...
resource "kubectl_manifest" "kubeflow-profiles-kfam-deployment-profiles-deployment" {
  yaml_body = <<YAML
apiVersion: apps/v1
kind: Deployment
metadata:
...
depends_on = [ovh_cloud_project_kube.ovh_kube_cluster, ovh_cloud_project_kube_nodepool.control_plane_pool, kubectl_manifest.kubeflow-kubeflow-namespace, kubectl_manifest.kubeflow-profiles-kfam-configmap-namespace-labels-data, kubectl_manifest.kubeflow-istio-deployment-istiod, kubectl_manifest.kubeflow-istio-mutatingwebhookconfiguration-sidecar-injector]
}

resource "kubectl_manifest" "kubeflow-profiles-kfam-virtualservice-profiles-kfam" {
  yaml_body = <<YAML
...
resource "kubectl_manifest" "kubeflow-profiles-kfam-authorizationpolicy-profiles-kfam" {
  yaml_body = <<YAML
